	...
	public static function createAppAllV3Folder ($app_id)
	{
		...
		foreach ($paths as $path) {
			...
			if ($result['code'] == 0 && $result['message'] = 'SUCCESS') {
				Utils::logFrom('SUCCESS appid=' . $app_id . " path=" . $path, 'createAppAllV3Folder.log');
			} else {
				Utils::logFrom('Failed appid=' . $app_id . " path=" . $path . " errMsg=" . print_r($result, 1), 'createAppAllV3Folder.log');
			}
		}
	}
