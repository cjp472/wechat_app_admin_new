...
@section('page_css')
    <link type=text/css rel="stylesheet" href="../css/admin/accountSetting/companymodel.css?{{env('timestamp')}}"/>
@endsection


@section('page_js')
    <script type="text/javascript" src="../js/admin/config/config.js"></script>
    <script type="text/javascript" src="../js/admin/accountSetting/companymodel.js?{{env('timestamp')}}"></script>
@endsection
...
@section('base_mainContent')
    ...
    <div class="content" >
        ...
        <div class="contentTip">
            ...
            <div class="contentText">如果您已开通“认证服务号”，且已向微信申请开通“微信支付权限”，您可以选择在此开通小鹅通企业模式。</div>
            <div class="contentText">开通企业模式后您可以使用自己的微信支付，通过企业模式产生的收入会直接进入您的微信支付对应的微信支付商户账号。</div>
            <div class="contentText">微信收取每笔0.6%的交易手续费。</div>
            <div class="contentText">
                为了保证所有功能正常，授权公众号时请保持默认选择，把权限统一授权给小鹅通。
