...
@section('base_mainContent')
    ...
    <div class="dataBox">
        <div class="myShop clearfix">
            ...
            <div class="btnContent">
                <span id="showShop" class="btnMid xeBtnDefault cm_shop">访问店铺</span>
        ...
        <div class="shopData clearfix">
            <div class="shopInfo">
                <div class="titleText">运营数据 <a href="/dashboard" class="cm_dataAnalysis">- 数据分析</a></div>
                <div class="content">
                    <div class="item">
            ...
            <div class="shopAccount">
                ...
                <div class="content">
                    <div class="item">
                        ...
                        <a href="/get_recharge_page" class="bottomBtn recharge cm_recharge">充值</a>
                    </div>
                    <div class="item">
                        ...
                        <a href="/apply_withdraw_page" class="bottomBtn record cm_record">提现</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="commonFun">
        ...
        <div class="content clearfix">
            <a href="/create_resource_page?type=1&upload_channel_type=1" class="itemBox">
                <img src="../images/admin/guide/new_artical.png" />
                <div>
                    <span class="cm_addArticle">图文</span>
                    <p>图文内容</p>
                </div>
            </a>
            <a href="/create_resource_page?type=2&upload_channel_type=1" class="itemBox">
                <img src="../images/admin/guide/new_audio.png" />
                <div>
                    <span class="cm_addMusic">音频</span>
                    <p>音频内容</p>
                </div>
            </a>
            <a href="/create_resource_page?type=3&upload_channel_type=1" class="itemBox">
                <img src="../images/admin/guide/new_video.png" />
                <div>
                    <span class="cm_addVideo">视频</span>
                    <p>视频内容</p>
                </div>
            </a>
            <a href="/create_resource_page?type=4&upload_channel_type=1" class="itemBox" style="margin-right:0">
                <img src="../images/admin/guide/new_alive.png" />
                <div>
                    <span class="cm_addAlive">直播</span>
                    <p>音频、视频等直播方式</p>
                </div>
            </a>
            <a href="/package_list_page" class="itemBox">
            ...
            <a href="javascript:void(0)" class="itemBox member_vip">
    ...
    <div class="association">
        ...
        <div class="content clearfix">
            <a href="/smallCommunity/communityList" class="itemBox ">
            ...
            <a href="javascript:void(0)" class="itemBox Q_A">
            ...
            @if(\App\Http\Controllers\Tools\AppUtils::IsPageVisual('active_manage', 'version_type'))
                <a href="/activityManage" class="itemBox cm_activity">
            ...
            @if(\App\Http\Controllers\Tools\AppUtils::isWhiltList(\App\Http\Controllers\Tools\AppUtils::getAppID()))
                <a href="javascript:void(0)" class="itemBox exerciseBook" style="margin-right: 0">
