...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/admin/upgradeVersion/newGrowUpVersionPage.css?{{env('timestamp')}}">
...
<body>
    ...
    <div class="mainContentPart" id="mainContent" style="display: block;">
        <div class="contentPartLeft">
            <div class="contentPic">
                <img src="images/pic_price_chenzhang.svg">
            </div>
            <div class="contentIntro">升级为小鹅通成长版用户，您将获得活动管理、付费问答、用户定向推送、会员制等众多强大功能</div>
        </div>
        <div class="contentPartRight">
            <div class="contentWord_1">小鹅通成长版</div>
            <div class="contentWord_2" onclick="window.location.href='/upgrade_account'">查看所有类型</div>
            <div class="contentChargePrice">¥100.00
                <div class="contentChargeSign">
                    <img src="images/payment-tick.png">
                </div>
            </div>
            <div class="contentWord_3">付款后该笔钱将直接充到您的流量账户余额中，可用来抵扣小鹅通平台的营运费用。(支付后不可退款)</div>
    ...
    {{--业务js--}}
    <script type="text/javascript" src="../js/admin/upgradeVersion/newGrowUpVersionPage.js?{{env('timestamp')}}"></script>
