        ...
        <table class="table_resource_list">
            ...
            <tbody>
                ...
                <tr class="tr_body">
                    ...
                    <td class="td_event_operate"><a data-good-id="{{$value->id}}" data-listen-count="{{$value->share_listen_count}}"  style="float:none" href="javascript:void(0);" class="copy_resource_link_btn shareNumSet">设置</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
...
@section('base_modal')
    <div class="set_share_num">
        <div class="set_share_window">
            <p class="set_share_title greyBack">设置领取上限</p>
            ...
            <div class="set_share_right">
                ...
                <div class="set_share_item_cont">
                    <input onkeyup="this.value=this.value.replace(/\D/g,'')" class="input_radio_value inputDefault set_share_good_num" placeholder="请输入领取上限(大于0的整数)">
                </div>
