...
@section('ahead_js')
    {{--文本编辑器--}}
    <script src="../ueditor/ueditor.config.js?{{env('timestamp')}}" type="text/javascript"></script>
...
@section('page_js')
    ...
    {{--腾讯云上传js--}}
    <script src="sdk/cos-js-sdk-v4.js?{{env('timestamp')}}" type="text/javascript">
    </script>
    <script src="js/admin/utils/v4QcloudUpload.js?{{env('timestamp')}}" type="text/javascript">
    </script>
    {{--云点播视频上传--}}
    ...
    <script src="//imgcache.qq.com/open/qcloud/js/vod/sdk/ugcUploader.js?{{env('timestamp')}}"></script>
    {{--获取文件MD5--}}
    <script src="../js/external/browser-md5-file.js?{{env('timestamp')}}" type="text/javascript">
    </script>
    {{--弹窗--}}
    ...
    <script src="../js/admin/resManage/manageVideo.js?{{env('timestamp')}}" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        //是否付费（1表示免费，2表示单笔）
        resFree = {{$resource_info->payment_type}};
        ...
        <div class="resAddPart resAddPart1">
          ...
          <div class="resAddSection">
                ...
                <div class="resAddSectionC">
                    <input class="resName inputDefault" name="resName" placeholder="请输入视频名称(建议字数在14字以内)"
                           type="text" value="@if($page_type==1){{$resource_info->title}}@endif"/>
                </div>
            </div>
            {{-- 视频上传 --}}
        <div class="resAddSection">
                ...
                <div class="resAddSectionC">
                    ...
                    <button id="video_file" class="waves-effect btnSmall xeBtnDefault resUploadBtn"
                            style="margin-left: 0">选择文件
                    </button>
                    ...
                    {{--</div>--}}
                    @if($page_type && ($resource_info->video_url||$resource_info->file_name))
                    <div id="videoName" class="hasUpNameContent">
                        <p class="hasUpName" title="{{$resource_info->file_name or $resource_info->video_url}}">{{$resource_info->file_name or $resource_info->video_url}}</p>
                ...
                <div class="resAddSectionC">
                    ...
                    <div class="waves-effect btnSmall xeBtnDefault coverUpbtn">
                        ...
                        <input type="hidden" id="Image1Url" type="text"
                               value="@if($page_type==1){{$resource_info->img_url}}@endif"/>
                    </div>
            ...
            <div class="resAddSection">
                ...
                <div class="resAddSectionC">
                    <div class="previewPic previewPicImage4">
                        <img src="@if($page_type&&$resource_info->patch_img_url!=null) {{$resource_info->patch_img_url}} @elseif($page_type&&$resource_info->patch_img_url==null) ../images/admin/resManage/pic_addfengmian.png @else ../images/admin/resManage/pic_addfengmian.png @endif" />
                    </div>
                    <div class="waves-effect btnSmall xeBtnDefault coverUpbtn">
                        <span>
                            选择文件
                        ...
                        <input accept="image/jpeg,image/png,image/gif,image/bmp"
                               class="upLoadImage upLoadImage4"
                               type="file"/>
                        <input type="hidden" id="Image4Url" type="text"
                               value="@if($page_type==1){{$resource_info->patch_img_url}}@endif"/>
                    </div>
                    <div class="coverUpTip">
                        建议尺寸750*422px或16：9，JPG、PNG格式， 图片小于5M。
                    </div>
                </div>
            </div>
            {{--视频详情--}}
                ...
                <div class="resAddSectionC">
                    ...
                    <div class="resDescribe">
                        ...
                        <script type="text/javascript">
                            ...
                            @if($page_type == 1  && $resource_info->org_content)
                            ue.ready(function () {
                ...
                <div class="resAddSectionC">
                    <div class="dateBox">
                        <input class="inputDefault dateInput dateSetInputBottom" id="dateInput" name="upDate" type="text"
                               value="@if($page_type==1){{$resource_info->start_at}}@endif"/>
