...
<head>
    ...
    <div class="content">
        <div class="content_part1">
            <div class="content_pic"><img src="images/pic_price_zunxiang.svg"></div>
            <div class="content_intro">升级为小鹅通专业版用户,您将获得首页名称自定义、视频播放+语音互动、新功能首发试用等众多专属功能</div>
        </div>
        <div class="content_part2">
            <div style="width:192px;height: 45px;line-height: 45px;margin-left: 30px;margin-top: 58px;font-size: 32px;color: #2a75ed">小鹅通专业版</div>
            ...
            <div class="content_charge_num">¥4800.00<div class="content_charge_num_t"><img src="images/payment-tick.png"></div></div>
            <div class="charge_intro">您将通过微信支付¥4800.00，有效期一年，到期时请及时充值续订。</div>
                        <!-- 服务协议部分 -->
<!--             <input type="checkbox" id="checkFlag" checked="checked"/> -->
    ...
    <div class="scan_screen " style="display: none">
        <div class="scan_screen_content" >
            <div class="pop-up_close"><img src="images/icon_Pop-ups_close.svg"></div>
        ...
        <script type="text/javascript" src="../js/admin/vipVersionPage.js?201702334"></script>
    </body>
