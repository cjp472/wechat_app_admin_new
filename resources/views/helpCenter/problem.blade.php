            ...
            <div class="documentPart">
                ...
                <div class="documentVideo" style="display: none">
                    <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="880" height="500"
                           ...
                           data-setup="{}">
                        <source class="videoSource" src="http://wechatapppro-1252524126.file.myqcloud.com/video/f65b250fdecfee1d5e61fc1bd117acf2.mp4" type='video/mp4' />
                        <source class="videoSource" src="http://wechatapppro-1252524126.file.myqcloud.com/video/f65b250fdecfee1d5e61fc1bd117acf2.mp4" type='video/webm' />
                        <source class="videoSource" src="http://wechatapppro-1252524126.file.myqcloud.com/video/f65b250fdecfee1d5e61fc1bd117acf2.mp4" type='video/ogg' />
